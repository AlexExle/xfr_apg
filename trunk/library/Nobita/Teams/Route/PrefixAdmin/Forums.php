...
class Nobita_Teams_Route_PrefixAdmin_Forums extends XenForo_Route_PrefixAdmin_Nodes
{
	/**
	...
	public function match($routePath, Zend_Controller_Request_Http $request, XenForo_Router $router)
	{
		...
		return $router->getRouteMatch('Nobita_Teams_ControllerAdmin_Forum', $action, 'nodeTree');
	}
